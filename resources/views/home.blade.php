                    ...
                    <div class="tm-gallery">
                        <div class="row">
                            <figure class="col-lg-3 col-md-4 col-sm-6 col-12 tm-gallery-item">
                                <a href="/Catalogs">
                                    <div class="tm-gallery-item-overlay">
                                        <img src="{{ asset('storage/image-01.jpg') }}" alt="Image" class="img-fluid tm-img-center">
                                    </div>
                            ...
                            <figure class="col-lg-3 col-md-4 col-sm-6 col-12 tm-gallery-item">
                                <a href="/Catalogs">
                                    <div class="tm-gallery-item-overlay">
                                        <img src="{{ asset('storage/image-02.jpg') }}" alt="Image" class="img-fluid tm-img-center">
                                    </div>
                            ...
                            <figure class="col-lg-3 col-md-4 col-sm-6 col-12 tm-gallery-item">
                                <a href="/Catalogs">
                                    <div class="tm-gallery-item-overlay">
                                        <img src="{{ asset('storage/image-03.jpg') }}" alt="Image" class="img-fluid tm-img-center">
                                    </div>
                            ...
                            <figure class="col-lg-3 col-md-4 col-sm-6 col-12 tm-gallery-item">
                                <a href="/Catalogs">
                                    <div class="tm-gallery-item-overlay">
                                        <img src="{{ asset('storage/image-04.jpg') }}" alt="Image" class="img-fluid tm-img-center">
                                    </div>
                            ...
                            <figure class="col-lg-3 col-md-4 col-sm-6 col-12 tm-gallery-item">
                                <a href="/Catalogs">
                                    <div class="tm-gallery-item-overlay">
                                        <img src="{{ asset('storage/image-05.jpg') }}" alt="Image" class="img-fluid tm-img-center">
                                    </div>
                            ...
                            <figure class="col-lg-3 col-md-4 col-sm-6 col-12 tm-gallery-item">
                                <a href="/Catalogs">
                                    <div class="tm-gallery-item-overlay">
                                        <img src="{{ asset('storage/image-06.jpg') }}" alt="Image" class="img-fluid tm-img-center">
                                    </div>
                            ...
                            <figure class="col-lg-3 col-md-4 col-sm-6 col-12 tm-gallery-item">
                                <a href="/Catalogs">
                                    <div class="tm-gallery-item-overlay">
                                        <img src="{{ asset('storage/image-07.jpg') }}" alt="Image" class="img-fluid tm-img-center">
                                    </div>
                            ...
                            <figure class="col-lg-3 col-md-4 col-sm-6 col-12 tm-gallery-item">
                                <a href="/Catalogs">
                                    <div class="tm-gallery-item-overlay">
                                        <img src="{{ asset('storage/image-08.jpg') }}" alt="Image" class="img-fluid tm-img-center">
                                    </div>
